    ...
    <>
      ...
      {!isOpen && (
        <motion.button
          ...
          className="fixed bottom-24 right-6 w-16 h-16 bg-[#FF9F1C] text-white rounded-full shadow-2xl flex items-center justify-center z-40 group overflow-hidden"
        >
      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-24 right-6 w-[380px] h-[550px] bg-white dark:bg-[#0F0F0F] rounded-3xl shadow-[0_20px_50px_rgba(0,0,0,0.2)] flex flex-col overflow-hidden z-50 border border-gray-200 dark:border-gray-800"
          >
            {/* Header */}
