        ...
        <AnimatePresence>
            {isOpen && (
                <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
                    ...
                    >
                        {/* Header */}
                        <div className="bg-gradient-to-br from-[#1B5E52] to-[#2D6A4F] p-6 flex items-center gap-4">
                            ...
                            {step === 'form' ? (
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            <select
                                                ...
                                                className="w-full appearance-none bg-gray-50 border-2 border-transparent focus:border-[#1B5E52] rounded-2xl px-4 py-3 text-sm font-medium outline-none transition-all"
                                            >
                                                    ...
                                                    className={`flex-1 py-2 rounded-xl text-xs font-bold transition-all border-2 ${form.priority === p
                                                            ? p === 'Urgent' ? 'bg-red-500 border-red-500 text-white'
                                                                : p === 'High' ? 'bg-orange-500 border-orange-500 text-white'
                                                                    : p === 'Medium' ? 'bg-[#1B5E52] border-[#1B5E52] text-white'
                                    ...
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className="w-full bg-gray-50 border-2 border-transparent focus:border-[#1B5E52] rounded-2xl px-4 py-3 text-sm outline-none transition-all"
                                        />
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={4}
                                            className="w-full bg-gray-50 border-2 border-transparent focus:border-[#1B5E52] rounded-2xl px-4 py-3 text-sm outline-none transition-all resize-none"
                                        />
                                    ...
                                    <div className="space-y-3">
                                        <label className="border-2 border-dashed border-gray-200 rounded-2xl p-4 flex items-center gap-3 cursor-pointer hover:border-[#1B5E52] transition-colors">
                                            <Paperclip className="w-5 h-5 text-gray-400" />
                                            <div className="flex-1">
                                                <p className="text-sm font-bold text-gray-700">Attach files</p>
                                        ...
                                        {attachments.length > 0 && (
                                            <div className="flex flex-wrap gap-2">
                                                {attachments.map((file, i) => (
                                                    <div key={i} className="flex items-center gap-2 bg-gray-100 px-3 py-1.5 rounded-xl text-xs">
                                ...
                                >
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-500 mt-2 text-sm">We'll get back to you within 24 hours at <span className="font-bold text-[#1B5E52]">{user?.email}</span></p>
                                    </div>
                                    <div className="bg-gray-50 rounded-2xl p-4">
                                        <p className="text-xs text-gray-400 uppercase tracking-widest mb-1">Ticket ID</p>
                                        <p className="text-2xl font-mono font-black text-[#1B5E52]">{ticketId}</p>
                                    </div>
                                    <button onClick={handleClose} className="w-full py-3 bg-[#1B5E52] text-white rounded-2xl font-bold text-sm hover:bg-[#164d43] transition-all">
                                        Back to App
                                    </button>
                                </motion.div>
                            )}
